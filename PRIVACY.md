...
- __Application__ refers to Cakesizer, the software program provided by the Company.
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cakesizer.
...
While using Our Service, we collect the following data which may contain Personally identifiable information about you:
...
- __To provide and maintain our Service__, including to monitor the usage of our Service, and to analyse crash reports
